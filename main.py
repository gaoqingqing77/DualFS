...
if __name__ == '__main__':
    ...
    parser.add_argument('--branch_mode', default='dual', type=str, choices=['dual', 'single'], help='the branch mode')
    parser.add_argument('--branch_1', default='fixed', type=str, choices=['ss', 'fixed', 'free'], help='the network type for the first branch')
    ...
    parser.add_argument('--init_epochs', default=200, type=int, help='the number of init_epochs')
    parser.add_argument('--epochs', default=170, type=int, help='the number of epochs')
    parser.add_argument('--compression_epochs', default=130, type=int, help='the number of compression_epochs')
    ...
    ### FOSTER parameters
    parser.add_argument('--foster_T', default=2, type=int, help='T for FOSTER')
    parser.add_argument('--lambda_okd', default=1, type=int, help='lambda for loss_kd')
    parser.add_argument('--beta1', default=[0.94], type=list, help='beta for loss_clf')
    parser.add_argument('--beta2', default=[0.97], type=list, help='beta for loss_compression')
